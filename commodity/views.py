...
class CommodityViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter(name='id', in_=openapi.IN_QUERY,
                              description='商品id', type=openapi.TYPE_STRING)
        ],
        responses={
            200: 'success":True,\n"commodity":商品資訊',
            400: 'success":False,\n"commodity":[]'
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter(name='keyword', in_=openapi.IN_QUERY,
                              description='商品keyword', type=openapi.TYPE_STRING)
        ],
        responses={
            200: '"data":[搜尋結果]',
        }
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter(name='Authorization', in_=openapi.IN_HEADER,
                              description='你的JWT token', type=openapi.TYPE_STRING)
        ],
        responses={
            200: '"success":True,\n"launched":上架的商品,\n"unlaunched":未上架的商品',
            400: '"success":False,\n"message":"錯誤訊息"'
    ...
    def launch(self, request):
        ...
        Commodity.objects.filter(
            id=int(commodity_id)).update(Launched=launched)
